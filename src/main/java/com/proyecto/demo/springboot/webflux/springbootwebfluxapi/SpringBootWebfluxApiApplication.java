package com.proyecto.demo.springboot.webflux.springbootwebfluxapi;

import com.proyecto.demo.springboot.webflux.springbootwebfluxapi.documents.Categoria;
import com.proyecto.demo.springboot.webflux.springbootwebfluxapi.documents.Producto;
import com.proyecto.demo.springboot.webflux.springbootwebfluxapi.services.ProductoService;
...
public class SpringBootWebfluxApiApplication implements CommandLineRunner {
	...
	private static final Logger log = LoggerFactory.getLogger(SpringBootWebfluxApiApplication.class);


	public static void main(String[] args) {
		SpringApplication.run(SpringBootWebfluxApiApplication.class, args);
	}
